    ...
    Scaffold(
        ...
        Column(
            ...
            LoginTextField(
                value = state.email,
                onValueChange = {
                    forgotPasswordViewModel.forgotPasswordEvent(ForgotPasswordEvent.OnEmailChange(it))
                },
                labelText = "Email",
            ...
            Button(
                onClick = {
                    forgotPasswordViewModel.forgotPasswordEvent(ForgotPasswordEvent.SendForgotPasswordLink)
                },
                modifier = Modifier.fillMaxWidth()
            ) {
                Text("Send")
